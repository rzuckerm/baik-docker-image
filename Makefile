BAIK_VERSION := $(shell cat BAIK_VERSION)
BAIK_DEPS := $(wildcard BAIK_*)
DOCKER_TAG_PREFIX := rzuckerm/baik:$(BAIK_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(BAIK_DEPS)
